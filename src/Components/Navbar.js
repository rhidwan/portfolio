    ...
    <header className="z-10 w-full px-32 lg:px-16 md:px-12 sm:px-6 font-medium py-8 flex items-center justify-between dark:text-light relative">
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex item-center justify-center flex-wrap">
          ...
          <motion.a
            href={
              "https://www.linkedin.com/in/rhidwan/"
            }
            target="_blank"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
        ...
        >
          ...
          <nav className="flex item-center justify-center flex-wrap mt-2">
            <motion.a
              ...
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
              className="w-8 bg-light rounded-full dark:bg-primary"
            >
              <GithubIcon />
            </motion.a>
            <motion.a
          ...
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
          className="w-8 ease ml-3 flex items-center justify-center rounded-full bg-light dark:bg-primary dark:text-light text-dark "
